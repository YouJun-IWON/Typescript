...
const a = add(1, 2);
// number를 string으로 바꾸면 error가 발생한다. 
const Hello = function() {
    console.log("Hello world~");
};
// 위의 경우 javascript는 undefined를 반환하지만 typescript의 경우 void를 반환한다. 
const Hello1 = function() {
    console.log("Hello world~");
};
const h = Hello1();
/// Any
// 모든 타입이 가능하다. 그러나 이러면 typescript를 쓰는 이유가 없으므로 거의 쓰이진 않는다. 
...
const z = 123;
const u = 123;
// z 를 u로 바꿨을 떄 any를 제외하고는 모든 error가 발생한다. 
// 즉, any 보다는 unknown을 사용하는 것이 좋다. 
const any = z;
const boo = z;
const num2 = z;
const arr1 = z;
...
// array와 다른 점은 tuple에서 설정한 모습과 같은 모습이어야 한다는 것이다. 
const users = [
    [
        1,
        "NEO",
...
/// Void
// 함수의 return값이 없을 때는 void로 설정해 줘야 한다.
function hallo(msg) {
